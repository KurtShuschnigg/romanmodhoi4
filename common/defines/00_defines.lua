...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.00001,			-- basic population growth per year, used for monthly manpower gain
	...
	LOCAL_MANPOWER_ACCESSIBLE_FACTOR = 0.1,         -- accessible recruitable factor base
	...
	POLITICAL_POWER_CAP = 150.0,					-- Max amount of political power country should have
...
NProduction = {
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 10000,	-- How many deployment lines minimum can be training
...
NMilitary = {
	...
	COMBAT_MOVEMENT_SPEED = 0.1,	               -- speed reduction base modifier in combat
...
NAI = {
	...
	UPGRADE_XP_RUSH_UPDATE = 30,				-- If XP is above this on the daily tick the AI will attempt to spend it
	...
	DEPLOYED_UNIT_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.01, 				-- deployment will try to buffer a ratio of deployed manpower (for reinforcements) during war time
	DEPLOYED_UNIT_MANPOWER_RATIO_TO_BUFFER_PEACETIME = 0.03,     		-- deployment will try to buffer a ratio of deployed manpower (for reinforcements) during peace time
